...
class TestPakrestore:
    ...
    def test_check_archive_exists_success(self):
        ...
        result = pakrestore.check_archive()
    ...
    @patch('pakrestore.run_pak_command')
    def test_revert_files_success(self, mock_pak_command):
        ...
        result = pakrestore.revert_files()
    ...
    @patch('pakrestore.check_archive')
    @patch('pakrestore.confirm_revert')
    @patch('pakrestore.revert_files')
    def test_revert_changes_success(self, mock_revert, mock_confirm, mock_check):
        ...
        with patch('sys.argv', ['pakrestore.py']):
            pakrestore.main()
    ...
    @patch('pakrestore.check_archive')
    @patch('sys.exit')
    def test_revert_changes_missing_archive(self, mock_exit, mock_check, mock_input):
    ...
    def test_revert_changes_force_mode(self, mock_revert, mock_check):
        ...
        with patch('sys.argv', ['pakrestore.py', '--force']):
            pakrestore.main()
